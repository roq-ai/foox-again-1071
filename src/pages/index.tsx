  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the power of connectivity with Foox again - Your trusted marketplace for freelancers and companies offering jobs, bringing opportunities closer to you."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of connectivity with Foox again - Your trusted marketplace for freelancers and companies offering jobs, bringing opportunities closer to you.`}
            </Text>
            <Box
